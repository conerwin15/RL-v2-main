...
class HideReportCommentSuperadmin extends TemplateMailable
{
    ...
    public function __construct($reporter_name, $comment, $thread, $thread_link, $comment_link, $mailTemplateId)
    {
