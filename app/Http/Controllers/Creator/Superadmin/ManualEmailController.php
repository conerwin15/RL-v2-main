...
class ManualEmailController extends Controller
{
    ...
    public function sendMail (Request $request)
    {
        ...
        return view('creator.superadmin.manual-emails.index', compact('countries', 'regions', 'jobRoles', 'groups', 'roles', 'currentDate', 'endDate'));
    }
        ...
        if ($request->ajax())
        {
           ...
           $user =  $userQuery->orderBy('name')->get();
            ...
            return Datatables::of($user, $request)
                    ...
                    {
                       return $user->country_id ? $user->country->name : "N/A";
                    })
    ...
    public function scheduledMails (Request $request) {
        ...
        $scheduleMails = ScheduledEmailJob::all();
            ...
            return Datatables::of($scheduleMails, $request)
                    ...
                    ->addColumn('action', function($scheduleMails){
                        ...
                        if($scheduleMails->is_processed == 1)
                        {
                            ...
                            $actionBtn = "<a href='$href'><i class='fa fa-eye' aria-hidden='true'></i> $view </a><a href='$editHref'><i class='fa fa-pencil' aria-hidden='true'></i> &nbsp;$edit </a><button type='button' class='text-danger delete-user' data-href='$href' data-role='superadmin'><i class='fa fa-trash' aria-hidden='true'></i> $delete </button>";
                            return $actionBtn;
                        }
        ...
        return view('creator.superadmin.manual-emails.scheduled-mail');
    }
    /**
    ...
    public function editScheduledMail(Request $request, $id)
    {
        ...
        return view('creator.superadmin.manual-emails.edit', compact('id', 'scheduleMailJobs', 'currentDate', 'endDate', 'startDate', 'endRunAt', 'countries', 'regions', 'jobRoles', 'groups', 'roles', 'role', 'userIds'));
    }
    ...
    public function viewScheduledMail (Request $request, $id)
    {
        ...
        return view('creator.superadmin.manual-emails.view', compact('id', 'scheduleJob', 'startDate', 'endRunAt'));
    }
