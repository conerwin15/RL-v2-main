...
class DealerResource extends Controller
{
    ...
    public function create()
    {
        ...
        return view('creator.superadmin.users.dealer.create', compact(['jobRoles', 'countries', 'groups']));
    }
    ...
    public function show($id)
    {
        ...
        return view('creator.superadmin.users.dealer.show', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('creator.superadmin.users.dealer.edit', compact('user', 'jobRoles', 'countries', 'groups', 'regions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('superadmin/users')
                        ->with('success', \Lang::get('lang.dealer-update')); 
    }
    ...
    public function destroy(Request $request, $id)
    {
        try
        {
            ...
            $deleteDealerRecord = $this->deleteRecord($id);
    ...
    public function getDealerByRegion ($regionId) {
        ...
        $dealer = User::role('dealer')->where($where)->orderBy('name')->get(); 
        return $dealer;
    }
