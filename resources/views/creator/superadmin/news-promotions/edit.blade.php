...
<div class="dash-title container-fluid max-width">
    <div>
        <a  href="{{ url('/superadmin/news-promotions') }}"><b>{{__('lang.news-promotions')}} ></b></a> 
        <span class="bradcrumb">{{ __('lang.edit-news-promotions') }}</span>
    </div>
</div>

<form action="{{ url('/superadmin/news-promotions/' . $newsPromotion->id) }}" method="POST"
        ...
        <div class="col-sm-7 p-0">
            <div class="row">
                ...
                <div class="col-sm-12 mb-3">
                    ...
                    <textarea class=" form-control" rows="4" name="description"  id="description" required>{{ $newsPromotion->description }}</textarea>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    @if($newsPromotion->media != NULL)    
                        ...
                        @else
                            <a href="{!! url('/superadmin/news-promotions/'. $newsPromotion->id . '/attachment') !!}"
