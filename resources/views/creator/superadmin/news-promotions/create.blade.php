...
<div class="dash-title container-fluid max-width">
    <div>
        ...
        <span class="bradcrumb">{{ __('lang.add-news-promotions') }}</span>
    </div>
</div>

<form action="{{ url('/superadmin/news-promotions') }}" method="POST" enctype="multipart/form-data"
    id="add-news-promotions" class="container-fluid max-width">
    @csrf
        ...
        <div class="col-sm-7 p-0">
            <div class="row">
                ...
                <div class="col-sm-12 mb-3">
                    ...
                    <textarea class="form-control mytext" rows="4" name="description" placeholder="{{ __('lang.description') }}"  id="description" required>{{ old('description') }}</textarea>
                    @if($errors->has('description'))
                        <div class="errorMsg" id="descriptionError">{{ $errors->first('description') }}</div>
                    @endif
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <select name="filter_country" id="country" class="countries select form-control" onchange="getRegion(this.value , true)" required>
