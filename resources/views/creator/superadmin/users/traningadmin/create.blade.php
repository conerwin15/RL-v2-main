...
<div class="dash-title container-fluid">
    <div>
        ...
        <span class="bradcrumb">{{__('lang.add-admin')}}</span>
    </div>
</div>
  
<form action="{{ url('/superadmin/trainingadmins') }}" method="POST" id='add_user'  class="container-fluid">
    @csrf
            ...
            <div class="col-sm-6">
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <select  name="country_id" id="country" onchange="getRegionAdmin(this.value, false)" class="select form-control"  required>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                            <button onclick="dropDown(event);" class="select form-control" type="button" id="region" style="text-align: inherit;" required disabled>
                            {{__('lang.select-region')}} <span class="custom-dropdown-symbol"> &#9013; </span>
                            </button>

                            <div class="shadow rounded menu" id="region-checkbox" style="OVERFLOW-Y:scroll; position: absolute; background: white; z-index: 1; WIDTH:90%; HEIGHT: 300px; display:none;">
                                <!-- add region by js -->
                            </div>
