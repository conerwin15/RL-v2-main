...
<div class="dash-title container-fluid">
    <div>
        ...
        <span class="bradcrumb">{{__('lang.add-staff')}}</span>
    </div>
</div>

<form action="{{ url('superadmin/customers') }}" method="POST" id='add_user' class="container-fluid">
    @csrf
            ...
            <div class="col-sm-6">
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <select  name="region_id" id="region" onchange="getDealer()" class="select form-control"  required disabled>
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <select  name="dealer_id" id="dealer" class="select form-control"  required disabled>
