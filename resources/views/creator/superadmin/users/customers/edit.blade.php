...
<div class="dash-title container-fluid">
    <div>
        <a  href="{{ url('/superadmin/users') }}"><b>{{__('lang.staff')}} ></b></a> 
        <span class="bradcrumb">{{__('lang.edit-staff')}}</span>
    </div>
</div>
<form action="{{ url('superadmin/customers/' . $user->id) }}" method="POST" id='add_user' class="container-fluid">
    @csrf
    @method('PUT')
            ...
            <div class="col-sm-6">
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <select  name="dealer_id" id="dealer"  class="form-control select" required>
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <select  name="region_id" id="region" class="form-control select"  onchange="getDealer()" required>
