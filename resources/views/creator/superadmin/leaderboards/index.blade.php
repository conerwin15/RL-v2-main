...
<div class="container-fluid max-width">
                    ...
                    <div class="emp-details">
                        <div class="basic-details">
                            <div class="flex justify-content-between">
                                ...
                                <div class="flex">
                                    <a href = "{{ url('/superadmin/mark-featured/' . $EmpOfTheMonth->user->id . '/edit') }}"> {{ __('lang.edit-featured-content') }} </a>
                                    <form action="{{ url('/superadmin/mark-featured') }}" method="POST" class="mb-0 ml-2">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="flex justify-content-end mt-4">
            ...
            <div class="flex">
                <a href="{{url('/superadmin/manage-points')}}"   class="btn-theme mr-2">{{ __('lang.manage-points-bulk') }} </a>
                <a href="{{url('/superadmin/featured-records')}}" class="btn-theme">{{ __('lang.featured-record') }} </a>
                </div>
        </div>
      
    <div class="white-wrapper mt-2">
        <h5 class="bg-blue" style="margin: -15px -15px  16px -15px">{{ __('lang.leaderboard') }}</h5>
...
<script>
    /*********** datatable ***********/
        $(document).ready(function() {
            ...
            var ajaxUrl = "{{url('superadmin/leaderboard')}}" + window.location.search;
