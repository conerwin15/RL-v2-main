...
<div class="dash-title container-fluid mt-2">
    <div>
        ...
        <span class="bradcrumb">{{ __('lang.edit-banner') }}</span>
    </div>
</div>

<form action="{{ url('/superadmin/banners/' . $banner->id) }}" method="POST" enctype="multipart/form-data" >
    @csrf
    @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-8">
                    <div class="form-group">
                        ...
                        <textarea class="form-control descriptionText" rows="4" name="description" placeholder="{{ __('lang.description') }}" maxlength = "1200" required> {{$banner->description}}</textarea>
                ...
                <!-- <div class="row"> -->
                    <div class="form-group col-sm-5">
                        ...
                        <div class="featuredimg">
                            <div>
                                ...
                                <input type="file" id="file" name="image"  accept="image/x-png"/>
                    ...
                    <div class="form-group col-sm-5">
                        ...
                        <div><img src="{{($banner->image!= null) ? asset('storage' . Config::get('constant.BANNER_STORAGE') . $banner->image) : asset('assets/images/avatar_default.png')}}" alt="image" style="width: 50%;"></div>
                    </div>
