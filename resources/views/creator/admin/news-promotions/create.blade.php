...
<form action="{{ url('/admin/news-promotions') }}" method="POST" enctype="multipart/form-data"
    id="add-news-promotions" class="container-fluid">
    @csrf
        ...
        <div class="col-sm-7 p-0">
            <div class="row">
                ...
                <div class="col-sm-6  mb-3">
                        ...
                        placeholder="{{ __('lang.country') }}" value="{{ $user->country->name }}"
                        readonly>
                </div>
                ...
                <div class="col-sm-6  mb-3">
                        ...
                        <select id="region" name="region_id[]"  class="select form-control" multiple = "multiple" required>
