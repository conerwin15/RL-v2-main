...
<div class="piaggio-alert">
        ...
        <div class="white-wrapper pb-4">
            <div class="row align-items-end">
                ...
                <div class="col-sm-2">
                    ...
                    <select  name="filter_region" id="region" class="form-control select" >
    ...
    <form action="{{url('admin/mail/send')}}" method="POST" class="container-fluid" id="frm-manual">
        @csrf
            <div class="container-fluid">
                <div class="white-wrapper">
                    ...
                    @if($errors->has('learners_mail'))
                       <div class="errorMsg" id="quizTextError">{{ __('lang.manual-leaner-error') }}</div>
                    @endif
...
function updateDataTableSelectAllCtrl(table){
   ...
   $('#frm-manual').on('submit', function(e){
    ...
    $('#scheduleEmail').on('click', function (e){
        ...
        var ajaxurl = app_url + "/admin/schedule/mail" ;
        $.ajax({
            url: ajaxurl,
            type:'POST',
            data:formData,
