...
<form class="container-fluid max-width" method="GET">
        <div class="white-wrapper pb-4">
            <div class="row align-items-end">
                ...
                <select name="filter_region" class="select form-control" id="region" required>
                    <option value="0" disabled>{{ __('lang.select') }} {{ __('lang.region') }}</option>
...
<form action="{{ url('admin/leaderboard/user/manage-points') }}"  method="POST" >
