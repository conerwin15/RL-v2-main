...
<div class="container-fluid max-width">
    ...
    <div class="flex justify-content-end mt-4">
            ...
            <div class="flex">
                <a href="{{url('/admin/global/featured-records')}}" class="btn-theme">{{ __('lang.featured-record') }} </a>
                </div>
        </div>
...
<script>
    /*********** datatable ***********/
        $(document).ready(function() {
            ...
            var ajaxUrl = "{{url('admin/global/leaderboard')}}" + window.location.search;
            var table = $('.data-table').DataTable({
                ...
                "createdRow":  function(row) {
                    $(row).find('td:eq(4)').addClass('d-flex  white-space');
                }
            });
        });
    </script>
