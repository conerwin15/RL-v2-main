...
@section('content')
    ...
    <div class="dash-title container-fluid">
            <div>
                <a href="{{ url( 'admin/regional/leaderboard') }}"><b>{{ __('lang.leaderboard') }} </b></a> <b> &gt; </b>
        ...
        <div class="f-emp">
            ...
            <div class="flex justify-content-start">
                ...
                <div class="emp-details">
                    ...
                    <form class="mb-0" action="{{ url('/admin/regional/leaderboard/user/'.$pointStats[0]->user_id.'/points') }}" method="POST">
                        @csrf
...
@section('scripts')
    ...
    /*********** datatable ***********/
        $(document).ready(function() {
            ...
            var ajaxUrl = "{{url('admin/regional/view-point-history/'.$userid)}}" + window.location.search;
        ...
        $('.editBonusBtn').on('click', function () {
            ...
            var ajaxurl = app_url + "/" + logged_user + "/regional/bonus-reason/" + Id + '/edit';
            $.ajax({
                url: ajaxurl,
                type: 'POST',
                data: formData,
