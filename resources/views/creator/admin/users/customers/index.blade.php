...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            ...
            <a class="btn btn-success" href="{{ route('users.create') }}">{{__('lang.create-staff')}}
            </a>
                 ...
                 <td>
                    ...
                    <form action="{{ route('trainingadmins.destroy',$user->id) }}" method="POST">
                        ...
                        @method('DELETE')
                         ...
                         <button type="submit" class="btn btn-danger btn-sm" style="background-color: #e3342f;border-color: #e3342f;" onclick="return confirm('{{ __('lang.delete-confirmation-text') }}')">{{__('lang.delete')}}</button>
