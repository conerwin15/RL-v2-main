        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    @endif
                    &nbsp;
                    <a href="{{ url('/admin/learning-paths/resource/'.$user->id.'/'.$userLearningPath->learningPath->id) }}"> <button type="submit" class="btn-theme btn-sm noDecoration"> {{ __('lang.progress-in-detail') }} </button>  </a>
                </div>
