...
<form action="{{ url('/admin/sales-tips/' . $salesTip->id) }}" method="POST"
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    @if($salesTip->media != NULL)    
                        ...
                        @else
                            <a href="{!! url('/admin/sales-tips/'. $salesTip->id . '/attachment') !!}"
                ...
                <div class="col-sm-6  mb-3">
                        ...
                        <select id="region" name="region_id"  class="select form-control">
                            ...
                            @foreach ($regions as $region)
                                <option value="{{$region->id}}" {{ ($region->id == $salesTip->region_id) ? 'selected' : ''}}>{{ $region->name }}</option>
                            @endforeach
                        </select>
                </div>
