...
<div class="container-fluid max-width">
    ...
    <div class="container-fluid">
        <form class="container-fluid max-width" method="GET">
            <div class="white-wrapper pb-4">
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-3">
                        <label>{{__('lang.select-region')}}: </label>
        ...
        <form class="flex justify-content-end align-items-cener mt-4" method="GET" style="margin-top:5%">
            @if(isset($_GET['name']))
    ...
    <div class="container-fluid max-width">
        <div class="white-wrapper mt-2">
            <h5 class="bg-blue" style="margin: -15px -15px  16px -15px">
            {{__('lang.organisation-leaderboard') }}
            </h5>
            <div class="container-fluid">
...
<script>
    /*********** datatable ***********/
        $(document).ready(function() {
            ...
            var ajaxUrl = app_url + "/" + logged_user + "/regional/leaderboard" + window.location.search;
