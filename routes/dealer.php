...
use App\Http\Controllers\Learners\Dealer\UserController;
use App\Http\Controllers\Learners\Dealer\StaffResource;
use App\Http\Controllers\Learners\Dealer\HomeController;
...
use App\Http\Controllers\Learners\Shared\LearningPathController; 
...
Route::group(['namespace' => 'Learners\Dealer', 'as'=>'dealer.'], function() {
    Route::get('dashboard', 'HomeController@index');
    Route::get('leraners/export', 'HomeController@exportLearners');
    Route::resource('staff', 'StaffResource');
    Route::get('staff/learning-path/{id}', 'StaffResource@viewLearningPath');
...
Route::group(['namespace' => 'Learners\Shared', 'as'=>'dealer.'], function() {
...
Route::group(['namespace' => 'Shared', 'as'=>'dealer.'], function(){
